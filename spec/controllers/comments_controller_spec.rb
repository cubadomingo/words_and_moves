...
RSpec.describe CommentsController, type: :controller do
  ...
  describe "Create comment" do
    it "increases comment count" do
      sign_in user
      count = Comment.count
      post :create, params: { text: "This is a test comment", item_id: post_item.id, item_type: post_item.class.to_s }
      expect(Comment.count).to be > count
    end
    it "creates a new comment" do
      sign_in user
      post :create, params: { text: "This is a test comment", item_id: post_item.id, item_type: post_item.class }
